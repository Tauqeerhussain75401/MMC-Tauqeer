...
namespace ERP
{
	...
	public class TiffManager : IDisposable
	{
		...
		public void JoinTiffImages(string[] imageFiles,string outFile,EncoderValue compressEncoder,Image[] images)
		{
			try{
