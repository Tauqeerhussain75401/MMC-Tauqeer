...
namespace ERP.Forms
{
    public partial class XRayTemplateDesigner : Form
    {
        public XRayTemplateDesigner()
        {
            InitializeComponent();
        ...
        private void XRayTemplateDesigner_Load(object sender, EventArgs e)
        {
            SelectionFont = rtxtDoc.SelectionFont;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                string Id = (string)cmbTemplate.SelectedValue;
                DML.docTemplate_add_edit(Id, txtNewTemplate.Text, rtxtDoc.Rtf, "2",
                null,
                null,
                null,
                null,
